...
export default function ConsultationPageV15() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setSuccessMessage(
          "Thank you! Your consultation request has been submitted. We'll get back to you soon.",
        );
  ...
  return (
    <section
      id="consultation"
      className="scroll-mt-24 px-6 md:px-8 lg:px-0 py-24 md:py-32 lg:py-40"
    >
        ...
        <div className="grid grid-cols-1 gap-20 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5 px-4 md:px-8 lg:px-0">
            ...
            <p className="mt-10 text-xl text-gray-700 leading-relaxed max-w-md hero-line">
              ...
              journey with LushWare ORG today.
            </p>

            <div className="mt-10 space-y-10">
              {/* Service List */}
              <div className="space-y-4">
                {["Client Support", "Project Guidance", "Quick Assistance"].map(
                  (item) => (
                    <div key={item} className="flex items-center gap-3">
                      <CheckCircle2 size={18} className="text-emerald-600" />
                      <span className="text-md font-bold text-gray-800 tracking-tight hero-line">
                        {item}
                      </span>
                    </div>
                  ),
              ...
              <div className="pt-10 border-t border-gray-300 flex flex-col gap-6">
                <div>
                  ...
                  <a
                    ...
                    className="group flex items-center gap-2 text-xl font-medium text-gray-900 hover:text-green-600 transition-colors underline decoration-gray-200 underline-offset-8 decoration-1 hover:decoration-green-600"
                  >
                    info@lushware.org{" "}
                    <ArrowUpRight
                      size={16}
                      ...
                      <div className="flex items-center gap-4 group">
                        ...
                        <div className="flex flex-col">
                          ...
                          <a
                            ...
                            className="text-[17px] font-medium text-gray-900 hover:text-blue-800 transition-colors tracking-tight"
                          >
                            +44 7777 667074
                          </a>
                        </div>
          ...
          <div className="lg:col-span-7">
            <div className="relative rounded-[1rem] md:rounded-[1.5rem] lg:rounded-[2rem] bg-white p-0.5 shadow-[0_2px_10px_rgba(0,0,0,0.02)] ring-1 ring-emerald-500">
              <form
                className="px-6 md:px-14 lg:px-16 py-8 lg:p-16"
                ...
                <div className="grid grid-cols-1 gap-x-12 gap-y-16 sm:grid-cols-2">
                  ...
                  <div className="relative space-y-1 group">
                    <label className="flex items-center gap-2 text-[16px] font-semibold uppercase tracking-widest text-gray-700 group-focus-within:text-emerald-600 transition-colors">
                      <span className="font-serif italic lowercase text-lg opacity-90">
                        i.
                      </span>{" "}
                      First Name
                    </label>
