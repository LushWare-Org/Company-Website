    ...
    <section className="w-full py-24 px-6">
      <div className="max-w-7xl pt-6 md:pt-12 mx-auto">
        ...
        <div className="max-w-6xl mt-12 mx-auto text-center mb-16">
          ...
          <p className=" text-lg md:text-xl text-slate-600 font-medium max-w-7xl mx-auto hero-line">
        ...
        <section className="py-12 md:py-16 px-4 md:px-0">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-12 md:mb-20 text-center md:text-left">
              ...
              <h3 className="text-4xl sm:text-5xl md:text-6xl font-semibold text-slate-900 tracking-tight mb-6 md:mb-8">
                How <span className="text-emerald-600">AI Agents</span> &
                Chatbots <br className="hidden md:block" />
                Drive Your Enterprise
              </h3>
              <p className="text-lg sm:text-xl md:text-xl text-slate-800 max-w-5xl leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 auto-rows-[minmax(280px,_auto)]">
              ...
              <div className="md:col-span-8 group relative overflow-hidden rounded-3xl md:rounded-[2.5rem] bg-[#062c1b] p-7 md:p-12 flex flex-col justify-end shadow-2xl">
                ...
                <div className="relative z-10">
                  <div className="inline-block px-4 md:px-5 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs font-bold uppercase tracking-[0.2em] mb-6 md:mb-8">
                    Autonomous Excellence
                  </div>
                  <h4 className="text-3xl md:text-4xl font-semibold text-white mb-4 md:mb-8 tracking-tight">
                    About AI Agents
                  </h4>
                  <p className="text-white text-base sm:text-lg md:text-xl leading-relaxed max-w-2xl font-light">
              ...
              <div className="md:col-span-4 group rounded-3xl md:rounded-[2.5rem] bg-white border border-emerald-200 p-6 md:p-10 hover:shadow-2xl hover:shadow-emerald-900/5 transition-all duration-500 flex flex-col">
                <div className="mb-auto">
                  <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-emerald-50 flex items-center justify-center text-emerald-600 mb-6 md:mb-8 group-hover:bg-emerald-600 group-hover:text-white transition-all duration-500 shadow-sm">
                    <svg
                  ...
                  <h4 className="text-2xl md:text-3xl font-semibold text-slate-700 tracking-tight mb-4 md:mb-6">
                    About AI Chatbots
                  </h4>
              ...
              <div className="md:col-span-12 group rounded-3xl md:rounded-[2.5rem] bg-white border border-emerald-300 p-7 md:p-12 relative overflow-hidden">
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6 md:gap-12">
                  <div className="md:max-w-xl">
                    <h4 className="text-3xl md:text-4xl font-semibold text-emerald-900 mb-3 md:mb-4 tracking-tight">
                      How We Add Value
                    </h4>
                  ...
                  <div className="flex-shrink-0">
                    <div className="text-5xl md:text-6xl font-serif text-emerald-300 group-hover:text-emerald-300 transition-colors duration-500">
                      Growth.
                    </div>
                  </div>
                </div>
