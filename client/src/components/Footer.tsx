          ...
          <div className="flex flex-col gap-4 lg:items-end">
            ...
            >
              <div className="absolute inset-0 rounded-full p-[1.5px] overflow-hidden">
                <div
                  className="absolute inset-[-1000%] animate-[spin_10s_linear_infinite] group-hover:animate-[spin_2s_linear_infinite] 
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-16 gap-x-8 pb-8">
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              <li>
                <AnimatedLink to="/solutions">Our Solutions</AnimatedLink>
              </li>
              <li>
                <AnimatedLink to="/solutions">Web Development</AnimatedLink>
              </li>
              <li>
                <AnimatedLink to="/solutions">Mobile Apps</AnimatedLink>
              </li>
              <li>
                <AnimatedLink to="/solutions">Custom Software</AnimatedLink>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              <li>
                <AnimatedLink to="/contact">Get in Touch</AnimatedLink>
              </li>
              <li>
                <AnimatedLink to="/contact">Request a Quote</AnimatedLink>
              </li>
              <li>
                <AnimatedLink to="/contact">Free Consultation</AnimatedLink>
              </li>
              <li>
                <AnimatedLink to="/contact">Help Center</AnimatedLink>
              </li>
            </ul>
          </div>
